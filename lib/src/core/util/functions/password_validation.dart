...
String? validatPassword3(String? value) {
  ...
  if (value == null || value.length < 8) {
    return "passwordMustBeAtLeastWithDetails $specialleteral";
  }
  ...
  if (countAlpha < 5) {
    validationValues.add("fiveAlphabetCharacters");
  }
  ...
  if (countDigit < 2) {
    validationValues.add("TwoNumbers");
  }
  ...
  if (countSpecial < 1) {
    validationValues.add("oneSpecialCharachtersLike $specialleteral");
  }
...
String? _joinValidations(List<String> validations) {
  ...
  final s = "passwordMustContainAtLeast";
  final comma = "comma";
  final and = "and";
